...
func (p *Provider) SessionRead(sid string) (sessions.Store, error) {
	if p.client == nil {
...
func (p *Provider) SessionRegenerate(oldsid, sid string) (sessions.Store, error) {
...
func init() {
	sessions.Register("ssdb", ssdbProvider)
}

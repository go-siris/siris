...
// Usage:
// import(
//   _ "github.com/go-siris/siris/sessions/memcache"
//   "github.com/go-siris/siris/sessions"
// )
//
//	func init() {
//		globalSessions, _ = sessions.NewManager("memcache", ``{"cookieName":"gosessionid","gclifetime":3600,"ProviderConfig":"127.0.0.1:11211"}``)
...
func (rp *MemProvider) SessionRead(sid string) (sessions.Store, error) {
	if client == nil {
...
func (rp *MemProvider) SessionRegenerate(oldsid, sid string) (sessions.Store, error) {
	if client == nil {
		if err := rp.connectInit(); err != nil {
			return nil, err
		}
...
func init() {
	sessions.Register("memcache", mempder)
}
